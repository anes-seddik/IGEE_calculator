...
class L01_S2 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_l01_s2)
        sharedPrefs = getSharedPreferences("spL1S2",Context.MODE_PRIVATE)
    ...
    fun calculateFinal(view: View) {
        ...
        if (error){
            ...
            //averages:
            val avrg1 = calcAverages(cont1,exam1);val coeff1 = 2
            val avrg2 = calcAverages(cont2,exam2);val coeff2 = 3
            val avrg3 = calcAverages(cont3,exam3);val coeff3 = 2
            val avrg4 = calcAverages(cont4,exam4);val coeff4 = 3
            val avrg5 = calcAverages(cont5,exam5);val coeff5 = 2
            val avrg6 = calcAverages(cont6,exam6);val coeff6 = 1
            val avrg7 = calcAverages(cont7,exam7);val coeff7 = 1
            val avrg8 = calcAverages(cont8,exam8);val coeff8 = 1
            val avrg9 = calcAverages(cont9,exam9);val coeff9 = 2
